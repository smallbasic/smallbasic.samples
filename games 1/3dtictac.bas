...
if xmax>319 then xxmax=320 else xxmax=xmax
if ymax>319 then yymax=320 else yymax=ymax
view 1,1,xxmax,yymax
WINDOW 1,320,320,1
...
apuy=200
If pz(m) > 0 Then
 locate 6,1: print "UPS!"
 locate 7,1: print "Spot"
 locate 8,1:print "used"
 Goto main
 FI
 locate 6,1: print "    "
 locate 7,1: print "    "
...
For i = 1 To 76
 ...
 If bb = 4 Then
  ...
  locate 6,1:print "WIN!"
   ...
   delay 2000
  locate 8,1:print"PLAY"
  locate 9,1:print"AGAIN"
  locate 10,1:input"Y/N",tt
